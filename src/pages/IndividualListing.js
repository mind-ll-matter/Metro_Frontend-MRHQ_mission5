...
const IndividualListing = () => {
  ...
  console.log("this is the OLD IMAGES ARRAY ", listingData?.images);
  const images = listingData?.images.map((image, index) => {
    return listingData?.images[index].url;
  });

  console.log("THIS IS THE NEW IMAGES ARRAY ", images);
    ...
    <>
      {listingData !== null && (
        <>
          ...
          />
          {/* <GallerySection images={listingData?.images} /> */}
          ...
          <div className="bottom_section">
            <div className="data_section">
              ...
              />
              <DataSectionMid notesOnProperty={listingData?.description} />
              <DataSectionBot
